...
public class Testcase4_EditProfile extends Launch_Quit_Amazon
{
	...
	public void editprfle() throws EncryptedDocumentException, IOException
	{
//		DDT d1=new DDT();
//		d1.credentials();
...
//		WebElement icon= driver.findElement(By.xpath("//svg[@class='editNameIcon']"));
//		Assert.assertEquals(icon.isDisplayed(), true, "Sorry testcase is failed");
//		
